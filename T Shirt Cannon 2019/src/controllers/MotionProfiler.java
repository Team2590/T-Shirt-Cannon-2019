...
public class MotionProfiler {
	 ...
	 * 
	 * @param presets
	 *            : control gains and stuff
	 */
	public MotionProfiler(ControlPresets presets) {
	 ...
	 * 
	 * @param currentPos
	 *            : mechanisms current position
	 * @param setPoint
	 *            : the position you want the mechanism at
	 */
	public void setSetpoint(double currentPos, double setPoint) {
		...
		// System.out.println("setpoint " + setPoint + " " + isTrapezoidal + " " +
		// cruizingDistance);
	...
	public double calculate(double currentPos) {
		...
		if (!done) {
			...
			return (outputs[1] * controls.getkF()) + ((outputs[2] * controls.getkA()))
					+ (((outputs[0] - currentPos) * controls.getkP()));
		}
	 ...
	 * 
	 * @param nextDist
	 *            : robots desired position
	 * @param nextVel
	 *            : robots desired velocity
	 * @param nextAccel
	 *            : robots desired acceleration
	 */
